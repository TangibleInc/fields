...
class Context_TestCase extends WP_UnitTestCase {
	...
	public function test_fields_context() {
		$this->assertEquals(['default','elementor','beaver-builder'], tangible_fields()->contexts);
		...
		$this->assertEquals(['default','elementor','beaver-builder','custom'], tangible_fields()->contexts);
