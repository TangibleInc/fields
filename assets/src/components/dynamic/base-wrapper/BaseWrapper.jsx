...
const BaseWrapper = props => {
  ...
  const hasInsert  = ! props.readOnly && (buttonType === 'outside' || (! props.remove || props.remove.isDisabled))
  const hasClear   = ! props.readOnly && (buttonType === 'outside' || (props.remove && props.remove.isDisabled === false))
